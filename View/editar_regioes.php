<?php
    ...
    $opcoes_pais = $resultado_pais->fetch(PDO::FETCH_ASSOC);
    $opcoes_estado = $resultado_estado->fetch(PDO::FETCH_ASSOC);
    $opcoes_cidade = $resultado_cidade->fetch(PDO::FETCH_ASSOC);
