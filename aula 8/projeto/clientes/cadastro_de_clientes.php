...
<body id="caixaCadastro">
    ...
    <div class="container">
        ...
        <form action="cadastro_clin.php" method="post">
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary" style="margin-right: 70%; width:100% "id="btn" name="cadastrar">Cadastrar</button>
                </div>
            </div>
